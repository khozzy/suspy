    ...
    <div class="panel-body">
        ...
        <form:form modelAttribute="userEditForm" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <form:label path="name" class="col-lg-2 control-label"><spring:message code="name.header"/></form:label>
                <div class="col-lg-10">
                    <spring:message code="role.change.header" var="roleChangePlaceholder"/>
                    <form:input path="name" class="form-control" placeholder="${roleChangePlaceholder}" />
