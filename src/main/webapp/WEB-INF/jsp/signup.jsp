...
z languages--%>
<form class="form-horizontal" role="form" action="create/user" method="get">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="termsAcceptance" value="accepted"> I accept all terms and conditions.
                </label>
            </div>
        </div>
    </div>
