                ...
                <a class="list-group-item active">
                    <div class="row clearfix">
                        <div class="col-sm-3 column">
                            <div class="media friend-picture">
                                    <img src="/public/lib/assets/profile-default.jpg" alt="friend-picture">
                            </div>
                        </div>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <p class="text-center pull-right">942 220 215 <span class="glyphicon glyphicon-earphone "></span></p>
                    </div>
                    <div class="row">
                        <p class="text-center pull-right">Near Gate-3, Near Shreyas Crossing <span class="glyphicon glyphicon-map-marker "></span></p>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab3default" data-toggle="tab">Friends</a></li>
                        </ul>
                    </div>
