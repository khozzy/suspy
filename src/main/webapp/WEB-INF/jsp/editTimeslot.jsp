                ...
                <div class="panel-body">
                    <form:form modelAttribute="editTimeSlotForm" class="form-horizontal" role="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="date_from" type="date" class="form-control" placeholder="event name" value="${timeslot.from}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="hour_from" name="hour_from" type="time" placeholder="00:00" value="${oldTimeslot.from.hour}" class="form-control input-md">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="date_to" type="date" class="form-control" placeholder="event name" value="${oldTimeslot.to.date}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="hour_to"><spring:message code='place.form.timeslot.hour_to'/></label>
                            <div class="col-sm-10">
                                <input id="hour_to" name="hour_to" type="time" placeholder="00:00" value="${oldTimeslot.to.hour}" class="form-control input-md">
